...
class DrivingLicensePage extends StatefulWidget {
  const DrivingLicensePage({Key? key}) : super(key: key);
        ...
        children: [
            ...
            child: ListView(
              ...
              children: [
                ...
                Container(
                  margin: const EdgeInsets.symmetric(horizontal: 26),
                  child: const Text(
                    'Please upload your Driving License pictures to continue with the Verification process.',
                    ...
                    children: [
                      InkWell(
                        onTap: () {
                          showModalBottomSheet(
                            ...
                            context: context,
                            builder: (context) {
                              return const CamerPopUp(type: 'Driving License Front');
                            },
                          ).then((value) {
                            setState(() {});
                          });
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              child: IdentityFormProvider.drivingLicenseFront == null
                                  ? const Column(
                                      crossAxisAlignment: CrossAxisAlignment.center,
                            ...
                            IdentityFormProvider.drivingLicenseFront != null
                                ? OutlinedButton(
                                    ...
                                    onPressed: () {
                                      var imagePath = IdentityFormProvider.drivingLicenseFront;
                                      IdentityFormProvider.drivingLicenseFront = null;
                                      imagePath!.delete();
                                      setState(() {});
                                    },
                      ...
                      Column(
                        children: [
                          InkWell(
                            onTap: () {
                              showModalBottomSheet(
                                ...
                                context: context,
                                builder: (context) {
                                  return const CamerPopUp(type: 'Driving License Back');
                                },
                              ).then((value) {
                                setState(() {});
                              });
                            ...
                            child: Container(
                              ...
                              child: IdentityFormProvider.drivingLicenseBack == null
                                  ? const Column(
                                      crossAxisAlignment: CrossAxisAlignment.center,
                                      mainAxisAlignment: MainAxisAlignment.center,
                                      children: [
                          ...
                          const SizedBox(height: 2),
                          IdentityFormProvider.drivingLicenseBack != null
                              ? OutlinedButton(
                                  style: OutlinedButton.styleFrom(
                                    fixedSize: Size(width * 0.30, 30),
                                    backgroundColor: AppColors.baseColor,
                                  ...
                                  onPressed: () {
                                    var imagePath = IdentityFormProvider.drivingLicenseBack;
                                    IdentityFormProvider.drivingLicenseBack = null;
                                    imagePath!.delete();
                                    setState(() {});
                                  },
          ...
          Container(
            ...
            child: AppButton(
              text: 'Next',
              clickAction: () {
                if (IdentityFormProvider.drivingLicenseBack != null && IdentityFormProvider.drivingLicenseFront != null) {
                  Navigator.pushNamed(context, AppRoutes.rcaPage);
                } else {
