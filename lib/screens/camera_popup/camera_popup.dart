...
class CamerPopUp extends StatefulWidget {
  const CamerPopUp({Key? key, required this.type, this.index, this.total, this.front}) : super(key: key);
  final String type;
  final int? index, total;
  final bool? front;
  @override
  State<CamerPopUp> createState() => _CamerPopUpState();
}

class _CamerPopUpState extends State<CamerPopUp> {
